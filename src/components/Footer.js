    ...
    return (
        <>
            <footer className="footer">
                <p className="footer__watermark">&copy; 2021 Supersite, Powered by News API</p>

            <div className="footer__container">
                <p className="footer__home">Inicio</p>
            ...
            <div className="footer__container-mobile">
                <div className="footer__home-container-mobile">
                  <p className="footer__home-mobile">Inicio</p>
                ...
                <p className="footer__watermark-mobile">&copy; 2021 Supersite, Powered by News API</p>
            </div>
